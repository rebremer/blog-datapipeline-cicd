...
configs = {"fs.azure.account.auth.type": "OAuth",
           ...
           "fs.azure.account.oauth2.client.endpoint": "https://login.microsoftonline.com/" + dbutils.secrets.get(scope="dbrkeys",key="tenand-id") + "/oauth2/token"}
...
dbutils.fs.mount(
  source = "abfss://libraries@" + par_stor_name + ".dfs.core.windows.net/",
  mount_point = "/mnt/libraries",
  extra_configs = configs)

# COMMAND ----------

%sh
ls -l /dbfs/mnt/libraries
